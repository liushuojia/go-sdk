...
const TableNameQueryListDefault = "queryListDefault"

// QueryListDefault mapped from table <queryListDefault>
...
func (m *QueryListDefault) IsEmpty() bool {
	if m == nil {
		return true
	}
	return m.ID == 0
...
// TableName QueryListDefault's table name
func (*QueryListDefault) TableName() string {
	return TableNameQueryListDefault
}
